...
for dataset_loader in dataset_loaders:
    ...
    if n_features // 2 < 5:
        ...
        O = n_features // 2
    self_vime = SKLearnSelfSLVIME(
        [*[n_features for _ in range(5)],O],
        [n_features for _ in range(5)],
        [n_features for _ in range(5)],
        learning_rate=0.001,
        mask_p=0.25,
        max_iter=200,
    ...
    semi_vime = SKLearnSemiSLVIME(
        self_vime,[*[n_features for _ in range(4)]],
        verbose=False,
        learning_rate=0.001,
        mask_p=0.25,
        max_iter=200,
    ...
    standard_rf = Pipeline([
        ("prkeprocessing",AutoDataset(cat_thresh=ct)),
